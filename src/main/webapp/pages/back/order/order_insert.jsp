...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <%--编写数据增加表单--%>
            <form action="<%=basePath%>order/createOrder" method="post" class="form-horizontal" id="insertForm">
                ...
                <%--图书名称--%>
                <div class="form-group">
                    <label for="name" class="col-md-3 control-label">金额</label>
                    <div class="col-md-6">
                        <input type="text" name="price" id="price" class="form-control input-sm" value="${order.price }">
                    </div>
                </div>
