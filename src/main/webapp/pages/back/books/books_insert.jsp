...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <%--编写数据增加表单--%>
            <form action="<%=basePath%>book/bookCreate" method="post" class="form-horizontal" id="insertForm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea name="memo" id="memo" class="form-control" >${book.memo }</textarea>
                    </div>
                </div>

				<div class="form-group">
                    <label for="note" class="col-md-3 control-label">ISBN</label>
                    <div class="col-md-6">
                        <textarea name="isbn" id="isbn" class="form-control" >${book.isbn }</textarea>
                    </div>
                </div>
                <div class="form-group">
